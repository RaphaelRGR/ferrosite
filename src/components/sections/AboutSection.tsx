...
/**
 * AboutSection — grid coluna única em mobile, 2 colunas em desktop.
 * Imagem com textura SVG e placeholder enquanto foto não existe.
 */
export function AboutSection() {
  return (
    <section id="curso" className="bg-[#0A0A0A] py-16 sm:py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-1 items-center gap-10 md:gap-16 lg:grid-cols-2">
          ...
          <AnimatedSection translateY="translate-y-16">
            <div className="relative aspect-square w-full overflow-hidden rounded-2xl border border-[#3A3A3A] bg-[#1A1A1A] flex items-center justify-center">
          ...
          <AnimatedSection delay={200} translateY="translate-y-16">
            ...
            <h2 className="mb-6 sm:mb-8 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-white">
              {ABOUT_CONTENT.title}
            </h2>
            <p className="mb-8 sm:mb-10 text-base sm:text-xl leading-relaxed text-white/60">
              {ABOUT_CONTENT.description}
            </p>
            <Link
              href="/curso"
              className="inline-flex min-h-[52px] items-center justify-center rounded-full bg-white px-8 sm:px-10 text-sm sm:text-base font-bold text-black transition-all hover:bg-[#E84E1B] hover:text-white"
            >
