...
export function HeroSection() {
  return (
    ...
    <div className="relative h-[112vh] w-full">
      <section className="sticky top-0 flex h-[100vh] w-full flex-col items-center justify-start overflow-hidden bg-black">
        ...
        {/* CONTEÚDO */}
        <div className="relative z-10 flex flex-col items-center px-6 text-center lg:px-0 mx-auto max-w-5xl pt-[25vh]">
          <AnimatedSection delay={0} translateY="translate-y-12">
            <span className="mb-10 inline-block rounded-full border border-white/10 bg-white/5 px-6 py-2.5 text-[10px] font-black uppercase tracking-[0.2em] text-[#E84E1B] backdrop-blur-md shadow-[0_0_20px_rgba(232,78,27,0.1)] ring-1 ring-white/5">
              {HERO_CONTENT.badge}
            </span>
          ...
          <AnimatedSection delay={200} translateY="translate-y-12">
            <h2 className="mb-12 text-2xl font-light tracking-[0.1em] text-white/80 sm:text-3xl md:text-4xl drop-shadow-lg uppercase">
