...
const PILLARS = [
  ...
  {
    title: "Extensão",
    description: "Conexão direta com o mercado através da AFER e do FerroSite, promovendo hackathons, visitas técnicas e eventos que integram academia e indústria.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
