...
Gerado de `content/editorial-inventory.json` em 2026-09-26 — não editar à mão; edite o JSON e rode `npm run content:report`.
...
Rota: `/curso` · Código: `content/curriculum/*.json (gerado dos PDFs oficiais por scripts/curriculum_from_pdf.py) + src/content/curriculums.ts`

| content_id | tipo | valor (PT) | fonte | owner | status | verified_at | decisão | notas |
|---|---|---|---|---|---|---|---|---|
| `curso.curriculum.2025` | curriculum | Matriz 2025 (currículo 20251): 62 obrigatórias (incl. atividades complementares/extensão) + 24 optativas | public/grades/grade2025.pdf — CURRÍCULO DO CURSO 604, SeTIC/UFSC (sha256 no JSON) | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Estrutura, cargas, pré-requisitos e ementas extraídos do PDF em 2026-09-15. Falta owner/verified_at institucional. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `curso.curriculum.2016` | curriculum | Matriz 2016: 61 obrigatórias (4 slots de optativa obrigatória) + 28 optativas | public/grades/grade2016.pdf (sha256 no JSON) | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Pré-requisitos EMB5109 e EMB5628 citados no PDF não pertencem ao currículo (registrados em unknownPrerequisites). \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `curso.curriculum.2012` | curriculum | Matriz 2012: 61 obrigatórias + 7 optativas | public/grades/grade2012.pdf (sha256 no JSON) | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | O PDF não traz pré-requisitos: as arestas exibidas são as legadas do protótipo (prerequisitesSource=legacy-unverified), incluindo EMB5512→EMB5107 e EMB5605→EMB5116 (ambas fase 6). Confirmar com a coordenação. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `curso.curriculum.ementas` | narrative | Ementas editoriais do protótipo (13/15/10 disciplinas) — substituídas pelas ementas oficiais do PDF; texto preservado em content/curriculum/legacy-prototype.ts | — | — | DISCARDED | — | descartar | Não eram ementas oficiais. Removidas da UI em FLOW-001. |
...
Rota: `/curso` · Código: `src/components/public/curriculum/CurriculumExplorer.tsx`

| content_id | tipo | valor (PT) | fonte | owner | status | verified_at | decisão | notas |
|---|---|---|---|---|---|---|---|---|
| `curso.flowchart.dados` | curriculum | Fluxograma das matrizes 2025/2016/2012 (dados de src/content/curriculums.ts) | content/curriculum/*.json (PDFs oficiais) | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Fluxograma refeito em FLOW-002; dados canônicos com sha256 do PDF. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |

### Curso — laboratórios — `curso.labs`

Rota: `/curso` · Código: `CourseSections.tsx (CourseLabs) + src/content/labs.ts (content/labs.json)`

| content_id | tipo | valor (PT) | fonte | owner | status | verified_at | decisão | notas |
|---|---|---|---|---|---|---|---|---|
| `curso.labs.lista` | narrative | 14 laboratórios: LMSE, LMS, LabDSE, Robótica Avançada, NSO, LaCMa, LDTPav, LABMCI, LASC, IDA Lab, LIFE, Aeolus, LTS, LAV | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.2 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | LABMCI, LASC e IDA Lab sem página no portfólio (14). Confirmar owner e versão do portfólio. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
...
Rota: `/laboratorios` · Código: `src/app/(public)/[locale]/laboratorios/page.tsx + src/content/{labs,capabilities}.ts`

| content_id | tipo | valor (PT) | fonte | owner | status | verified_at | decisão | notas |
|---|---|---|---|---|---|---|---|---|
| `laboratorios.hub.lista` | narrative | 14 laboratórios do portfólio (11 com página, 1 duplicada, 3 só índice); primeira frase de 'O laboratório' em cada card | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Ordem do PDF. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.hub.capacidades` | narrative | Taxonomia de 20 capacidades (14) e vínculos lab↔capacidade com nível offered/prospective/pending derivados das seções 'Aplicações' | PLANO 14 + portfólio (seções Aplicações) | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Curadoria inicial; validar com coordenação. LDTPav: via permanente/geotecnia = potencial. LASC/IDA Lab: só pelo nome. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
...
| content_id | tipo | valor (PT) | fonte | owner | status | verified_at | decisão | notas |
|---|---|---|---|---|---|---|---|---|
| `laboratorios.responsavel.lmse` | person | Prof. Marcos Alves Rabelo, Dr. Eng. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.3 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.lms` | person | Prof. Marcelo Heidemann, D.Sc. — Civil/Geotechnical Engineer | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.4 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.labdse` | person | Prof. Régis Kovacs Scalice, Dr. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.5 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.robotica` | person | Prof. Roberto Simoni, Dr. Eng. — Coordenador do POSECM | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.6 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.nso` | person | Prof. Thiago Pontin Tancredi, Dr. Eng. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.7 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.lacma` | person | Prof. Wagner M. Pachekoski, Dr. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.8 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.life` | person | Prof. André Luís Condino Fujarra, Dr. Eng. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.9 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.aeolus` | person | Prof. Filipe Dutra da Silva, Dr. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.10 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.lts` | person | Prof. Tiago Vieira da Cunha, Dr. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.11 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.lav` | person | Prof. Thiago Antonio Fiorentin, Dr. Eng. · Prof. Yesid Ernesto Asaff, Dr. Eng. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.12 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.responsavel.ldtpav` | person | Prof. Breno Salgado Barra, Dr. Eng. · Prof. Yader Guerrero Pérez, Dr. Eng. | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.13 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Nome e titulação como no portfólio institucional; sem e-mail/telefone/sala. Confirmar consentimento de exibição. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
...
| content_id | tipo | valor (PT) | fonte | owner | status | verified_at | decisão | notas |
|---|---|---|---|---|---|---|---|---|
| `laboratorios.detalhe.lmse` | narrative | LMSE — Laboratório de Mecânica dos Sólidos Experimental: 3 parágrafos 'O laboratório', 4 'Histórico e projetos', 4 aplicações | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.3 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Texto verbatim do portfólio; validar com o responsável antes de VERIFIED. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.detalhe.lms` | narrative | LMS — Laboratório de Mecânica dos Solos: 4 parágrafos 'O laboratório', 4 'Histórico e projetos', 4 aplicações | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.4 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Texto verbatim do portfólio; validar com o responsável antes de VERIFIED. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
...
| `laboratorios.detalhe.robotica` | narrative | Lab. Robótica Avançada — página do PDF com corpo idêntico ao LabDSE; nada publicado além de nome/responsável | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.6 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Validar diferencial (14). \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.detalhe.nso` | narrative | NSO — Núcleo de Simulação e Otimização: 4 parágrafos 'O laboratório', 4 'Histórico e projetos', 4 aplicações | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.7 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Texto verbatim do portfólio; validar com o responsável antes de VERIFIED. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.detalhe.lacma` | narrative | LaCMa — Laboratório de Caracterização de Materiais: 4 parágrafos 'O laboratório', 4 'Histórico e projetos', 4 aplicações | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.8 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Texto verbatim do portfólio; validar com o responsável antes de VERIFIED. Contém typo de origem ('characterização'). \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
...
| `laboratorios.detalhe.aeolus` | narrative | Aeolus — Laboratório de Aerodinâmica: 4 parágrafos 'O laboratório', 4 'Histórico e projetos', 4 aplicações | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.10 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Texto verbatim do portfólio; validar com o responsável antes de VERIFIED. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
...
| `laboratorios.detalhe.labmci` | narrative | LABMCI — só no índice do portfólio (nome); página pendente | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.2 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | [CONTEÚDO PENDENTE] (35). \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.detalhe.lasc` | narrative | LASC — só no índice do portfólio (nome); página pendente | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.2 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | [CONTEÚDO PENDENTE] (35). \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
| `laboratorios.detalhe.idalab` | narrative | IDA Lab — só no índice do portfólio (nome); página pendente | referencias_ferro/Portfolio_Laboratorios_EFM_UFSC.pdf (sha256 e7909daf35fe…) p.2 | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | [CONTEÚDO PENDENTE] (35). \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
...
| content_id | tipo | valor (PT) | fonte | owner | status | verified_at | decisão | notas |
|---|---|---|---|---|---|---|---|---|
| `empresas.capacidades.contagens` | narrative | Por capacidade: nº de labs com capacidade descrita / potencial / sem página | src/content/capabilities.ts | Coordenação do curso | VERIFIED | 2026-09-25 | confirmar | Derivado da mesma curadoria de laboratorios.hub.capacidades. \| Validado pela coordenação do curso em 2026-09-25 (chat): fluxograma e grades vêm dos PDFs oficiais da matriz; laboratórios, responsáveis e capacidades vêm do Portfólio de Laboratórios EFM/UFSC. |
